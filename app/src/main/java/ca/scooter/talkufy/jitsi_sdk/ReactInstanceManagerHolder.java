...
class ReactInstanceManagerHolder extends Activity {
    ...
    private static List<NativeModule> createNativeModules(ReactApplicationContext reactContext) {
        ...
        try {
            ...
            Constructor<NativeModule> constructor = (Constructor<NativeModule>) amplitudeModuleClass.getConstructor(ReactApplicationContext.class);
            nativeModules.add(constructor.newInstance(reactContext));
    ...
    static void initReactInstanceManager(Application application) {
        if (reactInstanceManager == null) {
            ...
            reactInstanceManager = ReactInstanceManager.builder()
                    .setApplication(application).setBundleAssetName("index.android.bundle")
            ...
            if (devSettings != null) {
                devSettings.setElementInspectorEnabled(false);
            }
