...
public class JitsiMeetConferenceOptions implements Parcelable {
    ...
    public static class Builder {
        private URL serverURL;
        private JitsiMeetConferenceOptions room;
        private String subject;
        private String token;

        private Bundle colorScheme;
        private final Bundle featureFlags;
         ...
         * @return - The {@link Builder} object itself so the method calls can be chained.
         */
        public Builder setRoom(JitsiMeetConferenceOptions room) {
            this.room = room;
        ...
        public JitsiMeetConferenceOptions build() {
            ...
            options.room = String.valueOf(this.room);
        ...
        public Builder setRoom(String s) {
            return null;
        }
    }
