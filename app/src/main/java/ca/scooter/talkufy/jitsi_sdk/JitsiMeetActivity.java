...
public class JitsiMeetActivity extends AppCompatActivity
    ...
    public void onDestroy() {
        ...
        ca.scooter.talkufy.jitsi_sdk.JitsiMeetOngoingConferenceService.abort(this);
    ...
    protected JitsiMeetView getJitsiView() {
        JitsiMeetFragment fragment
                = (JitsiMeetFragment) getSupportFragmentManager().findFragmentById(R.id.jitsiView);
    ...
    public void join(@Nullable String url) {
        JitsiMeetConferenceOptions options
                = new JitsiMeetConferenceOptions.Builder()
                .setRoom("https://meet.jit.si/febjkshjjvxj")
                .build();
        join(options);
    }
    ...
    protected void onConferenceJoined(HashMap<String, Object> extraData) {
        ...
        ca.scooter.talkufy.jitsi_sdk.JitsiMeetOngoingConferenceService.launch(this);
    }
