...
class SettingsActivity : AppCompatActivity() {
 ...
 //       val prefCheckForUpdates: Preference = findPreference("prefCheckForUpdates")
        ...
        if (Pref.getDefaultLanguage(this) > -1)
            setting_nav_view.menu.findItem(R.id.setting_default_language)?.title =
                "Default Language (${languages[Pref.getDefaultLanguage(this)]})"
    ...
    private fun BottomSheetDialog.bindLanguageDialog(languages: MutableList<String>) {
        ...
        save_btn.setOnClickListener {
            ...
            if (selectedPosition > -1) {
                ...
                this@SettingsActivity.setting_nav_view.menu.findItem(R.id.setting_default_language)?.title =
                    "Default Language (${languages[selectedPosition]})"
            }
                            ...
                            FirebaseTranslateModelManager.getInstance()
                                ...
                                .addOnSuccessListener {
                                    ...
                                    if (position == Pref.getDefaultLanguage(context)) {
                                        ...
                                        selectedPosition = -1
                                        this@SettingsActivity.setting_nav_view.menu.findItem(R.id.setting_default_language)?.title =
                                            "Default Language (Tap to choose)"
                                    }
                                }
