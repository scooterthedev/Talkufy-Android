package ca.scooter.Say_Talk.utils
...
import ca.scooter.Say_Talk.activities.ImagePreviewActivity
import ca.scooter.Say_Talk.activities.MessageActivity
import ca.scooter.Say_Talk.models.Models
import ca.scooter.Say_Talk.utils.FirebaseUtils.ref.user
import com.google.firebase.auth.FirebaseAuth
import com.squareup.picasso.Picasso
import ca.scooter.Say_Talk.activities.UserProfileActivity
import ca.scooter.Say_Talk.utils.FirebaseUtils.ref.allMessageStatus
        ...
        FirebaseDatabase.getInstance().getReference(key_app_code)
            .addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    ...
                    Log.d(
                        "FirebaseUtils",
                        "onDataChange: current version = ${ca.scooter.Say_Talk.BuildConfig.VERSION_CODE}"
                    )
                    Log.d("FirebaseUtils", "onDataChange: available version = $versionCode")

                    if (versionCode > ca.scooter.Say_Talk.BuildConfig.VERSION_CODE) {
                        //show update dialog
                        context.alert {
