...
/**
 * The react-native side of Jitsi Meet's {@link ca.scooter.Say_Talk.jitsi_sdk.ConnectionService}. Exposes
 * the Java Script API.
 *
 * @author Pawel Domas
 */
...
class RNConnectionService
    ...
    private static final String TAG = ca.scooter.Say_Talk.jitsi_sdk.ConnectionService.TAG;
    ...
    static void setAudioRoute(int audioRoute) {
        for (ca.scooter.Say_Talk.jitsi_sdk.ConnectionService.ConnectionImpl c
                : ca.scooter.Say_Talk.jitsi_sdk.ConnectionService.getConnections()) {
    ...
    public void startCall(
        ...
        PhoneAccountHandle accountHandle
            = ca.scooter.Say_Talk.jitsi_sdk.ConnectionService.registerPhoneAccount(
        ...
        ca.scooter.Say_Talk.jitsi_sdk.ConnectionService.registerStartCallPromise(callUUID, promise);
        ...
        try {
            ...
            ca.scooter.Say_Talk.jitsi_sdk.ConnectionService.unregisterStartCallPromise(callUUID);
            promise.reject(e);
        }
    }
    ...
    public void reportCallFailed(String callUUID) {
        ...
        ca.scooter.Say_Talk.jitsi_sdk.ConnectionService.setConnectionDisconnected(
                callUUID,
    ...
    public void reportConnectedOutgoingCall(String callUUID) {
        ...
        ca.scooter.Say_Talk.jitsi_sdk.ConnectionService.setConnectionActive(callUUID);
    }
    ...
    public void updateCall(String callUUID, ReadableMap callState) {
        ca.scooter.Say_Talk.jitsi_sdk.ConnectionService.updateCall(callUUID, callState);
    }
}
