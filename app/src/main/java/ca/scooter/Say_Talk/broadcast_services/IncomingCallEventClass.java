package ca.scooter.Say_Talk.broadcast_services;
...
import ca.scooter.Say_Talk.activities.IncomingCallActivity;
        ...
        if (callSnapshot.hasChild("call_initiated_time") &&
            ...
            if (currentTime>(initiatedTime+600000)){
                ...
                if (Objects.requireNonNull(callSnapshot.child("call_status").getValue()).toString()
                    ...
                    switch (ca.scooter.Say_Talk.broadcast_services.PhoneStateBroadcastReciever.phoneState) {
