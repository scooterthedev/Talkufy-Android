...
import ca.scooter.Say_Talk.utils.Pref
import ca.scooter.Say_Talk.utils.utils.longToast
import ca.scooter.Say_Talk.views.AnimCheckBox
        ...
        recyclerView.adapter = object : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
            ...
            override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
                with(holder.itemView){
                    ...
                    item_checkbox.checkbox.isChecked = Pref.getDefaultLanguage(context) == position
                    if(item_checkbox.checkbox.isChecked) lastCheckbox = item_checkbox as AnimCheckBox?
